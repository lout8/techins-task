...
const Header = () => {
  ...
  return (
      <div className='relative flex flex-col justify-around items-center z-10 mb-40'>
        <div className={`absolute bg-bg-image dark:bg-dark-bg-image top-[0] h-screen w-full bg-cover transition duration-500 z-10 ${toggle === true ? " opacity-100 top-0 ": " opacity-0 top-full"}`}></div>
        <div className='absolute top-0 flex w-full justify-around items-center py-16 z-20'>
        ...
        <div className={`group hidden flex-col gap-8 items-center max-lg:flex absolute h-fit w-full transition duration-500 z-20 ${toggle === true ? " opacity-100 top-40": " opacity-0 right-full"}`}>
